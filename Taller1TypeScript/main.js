...
for (let i = 0; i < series.length; i++) {
    tabla === null || tabla === void 0 ? void 0 : tabla.insertAdjacentHTML('beforeend', '<tr class="table-secondary"><th scope="row">' + series[i].id + '</th> <td>' + series[i].nombre + '</td> <td>' + series[i].estudio + '</td> <td>' + series[i].temporadas + '</td></tr>');
